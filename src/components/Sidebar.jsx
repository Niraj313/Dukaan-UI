    ...
    <div>
      <button
        ...
        className={`inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg ${
          sidebarStatus ? 'sm:block' : 'sm:hidden'
        ...
        <div className='h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#1e2640]'>
          <div className='flex justify-between md:justify-start items-center ps-2.5 mb-5'>
            ...
            <svg
              ...
              stroke-width='1.5'
              stroke='currentColor'
              className='size-5 text-white absolute left-[82%] sm:block hidden'>
              <path
            ...
            <button
              ...
              aria-controls='logo-sidebar'
              type='button'
              className={`sm:hidden inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg ${
                sidebarStatus ? 'sm:block' : 'sm:hidden'
              }  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600`}>
              <IoClose />
            </button>
